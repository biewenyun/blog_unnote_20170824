...
<head>
    <title>title</title>
    <!--md-->
    <link rel="stylesheet" href="/static/plugins/editorMD/css/style.css"/>
...
<script src="/static/plugins/editorMD/js/jquery.min.js"></script>
...
<script type="text/javascript">
    ...
    <%--var postData = postJsonObj.data.articleContent;--%>
    ...
    $(function () {
        ...
        $.get("/static/plugins/editorMD/test.md", function (markdown) {
