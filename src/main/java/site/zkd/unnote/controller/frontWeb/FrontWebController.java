package site.zkd.unnote.controller.frontWeb;
...
//    public Object findPublishPost(HttpServletRequest request, int pageNum, int pageSize) throws Exception {
//        PageSplit page;
//        ResponseList<ArticleBean> list = new ResponseList<>();
//
...
//
//            List<PostCustom> tmp = postService.findAllPublish(pageNum, pageSize);
...
//            list.setData(tmp);
//
////            System.out.println(new GsonUtils().toJson(list));
//            return new GsonUtils().toJson(list);
//        } catch (Exception e) {
//            e.printStackTrace();
//            //查询失败
...
//        try {
//            List<PostCustom> allNew = postService.findAllNew();
...
////
////            List<ArticleBean> postsData = postService.findAllPublish(1, 10);   //首页下面的文章内容
////            List<ArticleBean> newData = postService.findAllNew();   //首页下面的文章内容
...
////            }
////            //设置作者信息
////            List<AuthorBean> userMeta = userService.getUser(0);
...
//        HomeBean.DataBean dataBean = new HomeBean.DataBean();   //首页下面的Data内容对象
//        try {
//            List<PostCustom> newData = postService.findAllNew();
//            if (null == newData || newData.isEmpty()) {
//                //页面上面推荐的文章信息不为空
//                dataBean.setNewPosts(null);
//                dataBean.setHotPosts(null);
...
//            homeBean.setMsg(ResponseList.OK_STR);
//
//            System.out.println(new GsonUtils().toJson(homeBean));
//            return new GsonUtils().toJson(homeBean);
//        } catch (Exception e) {
//            e.printStackTrace();
//            //查询失败
...
//        try {
//            List<AuthorBean> userMeta = userService.getUser(userId);
